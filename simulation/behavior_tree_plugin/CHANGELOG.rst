...
* Merge branch 'ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2
* Merge branch 'ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2
* Fix spelling after merge changes
* Merge remote-tracking branch 'tier4/ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2
* Merge remote-tracking branch 'tier4/ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2
* Merge branch 'ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2
* Merge branch 'ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2
...
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2-part2
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2-part2
* Remove unused ActionNode::getDistanceToConflictingEntity
* Use distance::distanceToNearestConflictingPose instead of ActionNode::getDistanceToConflictingEntity
...
* Merge branch 'ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2-part1
* Merge branch 'ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance-step-2-part1
* Fix: remove trailing underscore from function arguments
* Use traffic_simulator::distance::splineDistanceToBoundingBox instead of ActionNode::getDistanceToTargetEntity
* Port the change: ActionNode::getDistanceToTargetEntity -> traffic_simulator::distance::splineDistanceToBoundingBox
* Port ActionNode::getOtherEntitiesCanonicalizedEntityStatuses member function
...
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance
* Add missing return - fix refactoring mistake
* Removed function declaration that had no implementation
  The function was supposed to be removed as part of refactoring but this declaration was mistakenly omitted
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance
* Merge branch 'master' into ref/RJD-1387-hdmap-utils-to-lanelet-wrapper-distance
...
* Rename constant kTrajectorySegments to trajectory_segments for consistency
* Merge branch 'master' into feature/whole_new_front_entity_detection_logic
* Merge branch 'master' into feature/whole_new_front_entity_detection_logic
...
* Fix format
* Enhance front entity detection in FollowFrontEntityAction and FollowLaneAction using trajectory-based approach
* Refactor getFrontEntityNameAndDistanceByTrajectory to accept waypoints as input and handle insufficient waypoints case
* Add getFrontEntityNameAndDistanceByTrajectory method to ActionNode
* Contributors: Kotaro Yoshimoto, Taiga, Taiga Takano
...
* Merge branch 'master' into RJD-1057-remove-functions-forwarded-to-entity-base-middle
* Merge branch 'master' into RJD-1057-remove-functions-forwarded-to-entity-base-middle
* ref(behavior_tree_plugin): rename default value of current_action\_: "waiting" -> "none"
...
6.1.1 (2024-11-29)
------------------
* Merge pull request `#1435 <https://github.com/tier4/scenario_simulator_v2/issues/1435>`_ from tier4/fix/sonarcloud_warning
...
* Merge pull request `#1104 <https://github.com/tier4/scenario_simulator_v2/issues/1104>`_ from tier4/fix/entities-right-of-way
