...
* Merge branch 'master' into feature/small_fix_new_front_entity_detection_logic
* Fixed an issue where the parameter was not propagated.
...
* rollback wrongly edited parameter in parameters.yaml
* Delete "flashing_pedestrian" "shaking_misc" and add "no_noise_to_all" in parameter.yaml for default use
* Merge branch 'master' into feature/perception_noise_config_v3
* Adjust config/parameter.yaml for v3 noise model
* Merge branch 'master' into feature/perception_noise_config_v3
* Add perception noise config v3 candidate
* Contributors: Kotaro Yoshimoto
...
* Merge branch 'master' into feature/change_allow_goal_modification
* Merge branch 'master' into feature/change_allow_goal_modification
* Add legacy and new way to specify allow_goal_modification comment in scenario
* Merge branch 'master' into feature/change_allow_goal_modification
* Merge branch 'master' into feature/change_allow_goal_modification
* Add test scenario for allow_goal_modification
* Contributors: Kotaro Yoshimoto
...
16.3.10 (2025-05-20)
--------------------
* Merge pull request `#1598 <https://github.com/tier4/scenario_simulator_v2/issues/1598>`_ from tier4/fix/agnocastpreload
  fix: preload agnocast only when agnocast is enabled
* Merge branch 'master' into fix/agnocastpreload
* Merge branch 'master' into dependabot/pip/setuptools-78.1.1
* chore: adjust agnocast path by ROS_DISTRO
